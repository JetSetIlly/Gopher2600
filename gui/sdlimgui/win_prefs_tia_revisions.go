...
func (win *winPrefs) drawLateGRPx() {
	...
	imgui.Spacing()
	a := win.img.vcs.Env.Prefs.Revision.LateVDELGRP0.Get().(bool)
	if imgui.Checkbox("GRP0", &a) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LateVDELGRP0.Set(a)
		})
	}
	win.drawTIARevTooltip(revision.LateVDELGRP0)

	b := win.img.vcs.Env.Prefs.Revision.LateVDELGRP1.Get().(bool)
	if imgui.Checkbox("GRP1", &b) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LateVDELGRP1.Set(b)
		})
	}
...
func (win *winPrefs) drawRESPxUnderHMOVE() {
	...
	imgui.Spacing()
	a := win.img.vcs.Env.Prefs.Revision.LateRESPx.Get().(bool)
	if imgui.Checkbox("Late RESPx", &a) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LateRESPx.Set(a)
		})
	}
	win.drawTIARevTooltip(revision.LateRESPx)

	b := win.img.vcs.Env.Prefs.Revision.EarlyScancounter.Get().(bool)
	if imgui.Checkbox("Early Scancounter", &b) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.EarlyScancounter.Set(b)
		})
	}
...
func (win *winPrefs) drawLatePlayfield() {
	...
	imgui.Spacing()
	a := win.img.vcs.Env.Prefs.Revision.LatePFx.Get().(bool)
	if imgui.Checkbox("PFx", &a) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LatePFx.Set(a)
		})
	}
	win.drawTIARevTooltip(revision.LatePFx)

	b := win.img.vcs.Env.Prefs.Revision.LateCOLUPF.Get().(bool)
	if imgui.Checkbox("COLUPF", &b) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LateCOLUPF.Set(b)
		})
	}
...
func (win *winPrefs) drawLostMOTCK() {
	...
	imgui.Spacing()
	a := win.img.vcs.Env.Prefs.Revision.LostMOTCK.Get().(bool)
	if imgui.Checkbox("Players/Missiles/Ball", &a) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.LostMOTCK.Set(a)
		})
	}
...
func (win *winPrefs) drawLateRESPx() {
	...
	imgui.Text("RESPx")
	imgui.Spacing()
	a := win.img.vcs.Env.Prefs.Revision.RESPxHBLANK.Get().(bool)
	if imgui.Checkbox("HBLANK threshold", &a) {
		win.img.dbg.PushFunction(func() {
			win.img.vcs.Env.Prefs.Revision.RESPxHBLANK.Set(a)
		})
	}
