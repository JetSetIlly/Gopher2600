...
func newColors() *imguiColors {
	...
	cols.RIOTIOBit = imgui.CurrentStyle().Color(imgui.StyleColorButton)
	...
	cols.riotIOBit = imgui.PackedColorFromVec4(cols.RIOTIOBit)
