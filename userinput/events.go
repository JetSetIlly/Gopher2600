...
// EventText is like EventKeyboard in that it is generated by the system keyboard. The difference is
// that the Key field is mapped according to the system's keymap
...
// EventJoystickAxis data is generated by a digital joystick. The fire button on the hardware
// controller is represented by a gamepad button event.
type EventJoystickAxis struct {
	ID    plugging.PortID
	Horiz int16
	Vert  int16
}

// EventStelladaptor data is generated by the stelladaptor.The fire button on the hardware
// controller is represented by a gamepad button event.
