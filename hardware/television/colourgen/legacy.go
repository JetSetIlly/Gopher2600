...
// values taken from Stella 7.0 file common/PaletteHandler.cxx
//
// slightly changed so that the grayscale hues are all the same and black is
// 0x000000 and not 0x0b0b0b
var stellaPALfromStella = []uint32{
	0x000000, 0x333333, 0x595959, 0x7b7b7b, 0x8b8b8b, 0xaaaaaa, 0xc7c7c7, 0xe3e3e3,
	0x000000, 0x333333, 0x595959, 0x7b7b7b, 0x8b8b8b, 0xaaaaaa, 0xc7c7c7, 0xe3e3e3,
...
func useStellaPalette(legacy *legacyModel) {
	...
	for _, v := range stellaPALfromStella {
