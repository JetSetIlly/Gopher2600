...
func (cart dpc) ReadHotspots() map[uint16]mapper.CartHotspotInfo {
	return map[uint16]mapper.CartHotspotInfo{
		...
		0x1000: mapper.CartHotspotInfo{Symbol: "RNG", Action: mapper.HotspotRegister},
		0x1001: mapper.CartHotspotInfo{Symbol: "RNG", Action: mapper.HotspotRegister},
		0x1002: mapper.CartHotspotInfo{Symbol: "RNG", Action: mapper.HotspotRegister},
		0x1003: mapper.CartHotspotInfo{Symbol: "RNG", Action: mapper.HotspotRegister},
		0x1004: mapper.CartHotspotInfo{Symbol: "MUSIC", Action: mapper.HotspotRegister},
		0x1005: mapper.CartHotspotInfo{Symbol: "MUSIC", Action: mapper.HotspotRegister},
		0x1006: mapper.CartHotspotInfo{Symbol: "MUSIC", Action: mapper.HotspotRegister},
		0x1007: mapper.CartHotspotInfo{Symbol: "MUSIC", Action: mapper.HotspotRegister},
		...
		0x1010: mapper.CartHotspotInfo{Symbol: "DF0f", Action: mapper.HotspotRegister},
		0x1011: mapper.CartHotspotInfo{Symbol: "DF1f", Action: mapper.HotspotRegister},
		0x1012: mapper.CartHotspotInfo{Symbol: "DF2f", Action: mapper.HotspotRegister},
		0x1013: mapper.CartHotspotInfo{Symbol: "DF3f", Action: mapper.HotspotRegister},
		0x1014: mapper.CartHotspotInfo{Symbol: "DF4f", Action: mapper.HotspotRegister},
		0x1015: mapper.CartHotspotInfo{Symbol: "DF5f", Action: mapper.HotspotRegister},
		0x1016: mapper.CartHotspotInfo{Symbol: "DF6f", Action: mapper.HotspotRegister},
		0x1017: mapper.CartHotspotInfo{Symbol: "DF7f", Action: mapper.HotspotRegister},
		0x1018: mapper.CartHotspotInfo{Symbol: "DF0f/swp", Action: mapper.HotspotRegister},
		0x1019: mapper.CartHotspotInfo{Symbol: "DF1f/swp", Action: mapper.HotspotRegister},
		0x101a: mapper.CartHotspotInfo{Symbol: "DF2f/swp", Action: mapper.HotspotRegister},
		0x101b: mapper.CartHotspotInfo{Symbol: "DF3f/swp", Action: mapper.HotspotRegister},
		0x101c: mapper.CartHotspotInfo{Symbol: "DF4f/swp", Action: mapper.HotspotRegister},
		0x101d: mapper.CartHotspotInfo{Symbol: "DF5f/swp", Action: mapper.HotspotRegister},
		0x101e: mapper.CartHotspotInfo{Symbol: "DF6f/swp", Action: mapper.HotspotRegister},
		0x101f: mapper.CartHotspotInfo{Symbol: "DF7f/swp", Action: mapper.HotspotRegister},
		0x1020: mapper.CartHotspotInfo{Symbol: "DF0f/rev", Action: mapper.HotspotRegister},
		0x1021: mapper.CartHotspotInfo{Symbol: "DF1f/rev", Action: mapper.HotspotRegister},
		0x1022: mapper.CartHotspotInfo{Symbol: "DF2f/rev", Action: mapper.HotspotRegister},
		0x1023: mapper.CartHotspotInfo{Symbol: "DF3f/rev", Action: mapper.HotspotRegister},
		0x1024: mapper.CartHotspotInfo{Symbol: "DF4f/rev", Action: mapper.HotspotRegister},
		0x1025: mapper.CartHotspotInfo{Symbol: "DF5f/rev", Action: mapper.HotspotRegister},
		0x1026: mapper.CartHotspotInfo{Symbol: "DF6f/rev", Action: mapper.HotspotRegister},
		0x1027: mapper.CartHotspotInfo{Symbol: "DF7f/rev", Action: mapper.HotspotRegister},
		0x1028: mapper.CartHotspotInfo{Symbol: "DF0f/ror", Action: mapper.HotspotRegister},
		0x1029: mapper.CartHotspotInfo{Symbol: "DF1f/ror", Action: mapper.HotspotRegister},
		0x102a: mapper.CartHotspotInfo{Symbol: "DF2f/ror", Action: mapper.HotspotRegister},
		0x102b: mapper.CartHotspotInfo{Symbol: "DF3f/ror", Action: mapper.HotspotRegister},
		0x102c: mapper.CartHotspotInfo{Symbol: "DF4f/ror", Action: mapper.HotspotRegister},
		0x102d: mapper.CartHotspotInfo{Symbol: "DF5f/ror", Action: mapper.HotspotRegister},
		0x102e: mapper.CartHotspotInfo{Symbol: "DF6f/ror", Action: mapper.HotspotRegister},
		0x102f: mapper.CartHotspotInfo{Symbol: "DF7f/ror", Action: mapper.HotspotRegister},
		0x1030: mapper.CartHotspotInfo{Symbol: "DF0f/rol", Action: mapper.HotspotRegister},
		0x1031: mapper.CartHotspotInfo{Symbol: "DF1f/rol", Action: mapper.HotspotRegister},
		0x1032: mapper.CartHotspotInfo{Symbol: "DF2f/rol", Action: mapper.HotspotRegister},
		0x1033: mapper.CartHotspotInfo{Symbol: "DF3f/rol", Action: mapper.HotspotRegister},
		0x1034: mapper.CartHotspotInfo{Symbol: "DF4f/rol", Action: mapper.HotspotRegister},
		0x1035: mapper.CartHotspotInfo{Symbol: "DF5f/rol", Action: mapper.HotspotRegister},
		0x1036: mapper.CartHotspotInfo{Symbol: "DF6f/rol", Action: mapper.HotspotRegister},
		0x1037: mapper.CartHotspotInfo{Symbol: "DF7f/rol", Action: mapper.HotspotRegister},
		0x1038: mapper.CartHotspotInfo{Symbol: "FLG0", Action: mapper.HotspotRegister},
		0x1039: mapper.CartHotspotInfo{Symbol: "FLG1", Action: mapper.HotspotRegister},
		0x103a: mapper.CartHotspotInfo{Symbol: "FLG2", Action: mapper.HotspotRegister},
		0x103b: mapper.CartHotspotInfo{Symbol: "FLG3", Action: mapper.HotspotRegister},
		0x103c: mapper.CartHotspotInfo{Symbol: "FLG4", Action: mapper.HotspotRegister},
		0x103d: mapper.CartHotspotInfo{Symbol: "FLG5", Action: mapper.HotspotRegister},
		0x103e: mapper.CartHotspotInfo{Symbol: "FLG6", Action: mapper.HotspotRegister},
		0x103f: mapper.CartHotspotInfo{Symbol: "FLG7", Action: mapper.HotspotRegister},
	}
}
...
func (cart dpc) WriteHotspots() map[uint16]mapper.CartHotspotInfo {
	return map[uint16]mapper.CartHotspotInfo{
		...
		0x1058: mapper.CartHotspotInfo{Symbol: "DF0/hi", Action: mapper.HotspotRegister},
		0x1059: mapper.CartHotspotInfo{Symbol: "DF1/hi", Action: mapper.HotspotRegister},
		0x105a: mapper.CartHotspotInfo{Symbol: "DF2/hi", Action: mapper.HotspotRegister},
		0x105b: mapper.CartHotspotInfo{Symbol: "DF3/hi", Action: mapper.HotspotRegister},
		0x105c: mapper.CartHotspotInfo{Symbol: "DF4/hi", Action: mapper.HotspotRegister},
		0x105d: mapper.CartHotspotInfo{Symbol: "DF5/hi", Action: mapper.HotspotRegister},
		0x105e: mapper.CartHotspotInfo{Symbol: "DF6/hi", Action: mapper.HotspotRegister},
		0x105f: mapper.CartHotspotInfo{Symbol: "DF7/hi", Action: mapper.HotspotRegister},
		0x1060: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1061: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1062: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1063: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1064: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1065: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1066: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1067: mapper.CartHotspotInfo{Symbol: "LINE", Action: mapper.HotspotFunction},
		0x1068: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x1069: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106a: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106b: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106c: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106d: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106e: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x106f: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x1070: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1071: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1072: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1073: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1074: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1075: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1076: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1077: mapper.CartHotspotInfo{Symbol: "RNG/reset", Action: mapper.HotspotFunction},
		0x1078: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x1079: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107a: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107b: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107c: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107d: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107e: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
		0x107f: mapper.CartHotspotInfo{Symbol: "RESERVED", Action: mapper.HotspotReserved},
	}
}
