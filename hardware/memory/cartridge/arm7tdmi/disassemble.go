...
func Disassemble(opcode uint16) string {
	var f func(opcode uint16) string
...
func disasmMoveShiftedRegister(opcode uint16) string {
	// format 1 - Move shifted register
...
func disasmAddSubtract(opcode uint16) string {
	// format 2 - Add/subtract
...
func disasmMovCmpAddSubImm(opcode uint16) string {
	// format 3 - Move/compare/add/subtract immediate
...
func disasmALUoperations(opcode uint16) string {
	// format 4 - ALU operations
...
func disasmHiRegisterOps(opcode uint16) string {
	var entry DisasmEntry
...
func disasmPCrelativeLoad(opcode uint16) string {
	var entry DisasmEntry
...
func disasmLoadStoreWithRegisterOffset(opcode uint16) string {
	// format 7 - Load/store with register offset
...
func disasmLoadStoreSignExtendedByteHalford(opcode uint16) string {
	// format 8 - Load/store sign-extended byte/halfword
...
func disasmLoadStoreWithImmOffset(opcode uint16) string {
	// format 9 - Load/store with immediate offset
...
func disasmLoadStoreHalfword(opcode uint16) string {
	// format 10 - Load/store halfword
...
func disasmSPRelativeLoadStore(opcode uint16) string {
	// format 11 - SP-relative load/store
...
func disasmLoadAddress(opcode uint16) string {
	// format 12 - Load address
...
func disasmAddOffsetToSP(opcode uint16) string {
	// format 13 - Add offset to stack pointer
...
func disasmPushPopRegisters(opcode uint16) string {
	// format 14 - Push/pop registers
...
func disasmMultipleLoadStore(opcode uint16) string {
	// format 15 - Multiple load/store
...
func disasmConditionalBranch(opcode uint16) string {
	// format 16 - Conditional branch
...
func disasmSoftwareInterrupt(opcode uint16) string {
	// format 17 - Software interrupt"
	// panic("Software interrupt")
	return "INT"
}

func disasmUnconditionalBranch(opcode uint16) string {
	// format 18 - Unconditional branch
...
func disasmLongBranchWithLink(opcode uint16) string {
	// format 19 - Long branch with link
