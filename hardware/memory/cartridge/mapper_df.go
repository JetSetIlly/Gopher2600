...
func newDF(env *environment.Environment) (mapper.CartMapper, error) {
...
func (cart *df) GetBank(addr uint16) banking.Information {
...
func (cart *df) CopyBanks() []banking.Content {
...
func (cart *df) Hotspots() map[uint16]mapper.CartHotspotInfo {
