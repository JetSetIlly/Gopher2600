...
func newFA2(env *environment.Environment) (mapper.CartMapper, error) {
...
func (cart *fa2) GetBank(addr uint16) banking.Information {
...
func (cart *fa2) CopyBanks() []banking.Content {
