...
func GetInstructionDefinitions() ([]*InstructionDefinition, error) {
	return []*InstructionDefinition{
		...
		&InstructionDefinition{ObjectCode: 0x7, Mnemonic: "slo", Bytes: 2, Cycles: 5, AddressingMode: 4, PageSensitive: false, Effect: 2},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0x1c, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0x3c, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0x5c, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
		...
		&InstructionDefinition{ObjectCode: 0x6b, Mnemonic: "arr", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0x7c, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
		...
		&InstructionDefinition{ObjectCode: 0x82, Mnemonic: "dop", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
		nil,
		...
		&InstructionDefinition{ObjectCode: 0xb7, Mnemonic: "lax", Bytes: 2, Cycles: 4, AddressingMode: 11, PageSensitive: false, Effect: 0},
		...
		&InstructionDefinition{ObjectCode: 0xbf, Mnemonic: "lax", Bytes: 3, Cycles: 4, AddressingMode: 9, PageSensitive: true, Effect: 0},
		...
		&InstructionDefinition{ObjectCode: 0xcb, Mnemonic: "sax", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0xdc, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
		...
		nil,
		nil,
		&InstructionDefinition{ObjectCode: 0xfc, Mnemonic: "skw", Bytes: 3, Cycles: 4, AddressingMode: 8, PageSensitive: true, Effect: 0},
