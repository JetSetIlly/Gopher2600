...
func GetDefinitions() ([]*Definition, error) {
	return []*Definition{
		...
		&Definition{OpCode: 0x4, Mnemonic: "dop", Bytes: 2, Cycles: 3, AddressingMode: 4, PageSensitive: false, Effect: 0},
		...
		nil,
		&Definition{OpCode: 0x80, Mnemonic: "dop", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
		&Definition{OpCode: 0x81, Mnemonic: "STA", Bytes: 2, Cycles: 6, AddressingMode: 6, PageSensitive: false, Effect: 1},
		&Definition{OpCode: 0x82, Mnemonic: "dop", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
		nil,
		...
		&Definition{OpCode: 0xcb, Mnemonic: "sax", Bytes: 2, Cycles: 2, AddressingMode: 1, PageSensitive: false, Effect: 0},
