...
// CreateFromLoader will cause images to be generated by a running emulation
...
// CreateFromState will cause images to be returned generated by a running
// emulation starting from the supplied state. The emulation will run for a
// number of frames before ending.
//
